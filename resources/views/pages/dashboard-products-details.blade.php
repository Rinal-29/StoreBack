                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="product-name" name="product-name" id="product-name" class="form-control" value="Papel La Casa">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="price">Price</label>
                                            <input type="number" name="price" id="price" class="form-control" value="200">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-card-1.png" alt="product card" class="w-100">
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-card-2.png" alt="product card" class="w-100">
                                        <a href="#" class="delete-gallery">
                                            <img src="/images/icon-delete.svg" alt="icon delet">
                                        </a>
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="gallery-container">
                                        <img src="/images/product-card-3.png" alt="product card" class="w-100">
                                        <a href="#" class="delete-gallery">
                                            <img src="/images/icon-delete.svg" alt="icon delet">
                                        </a>
                                    </div>
